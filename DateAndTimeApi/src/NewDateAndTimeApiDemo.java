...
public class NewDateAndTimeApiDemo {
...
//        System.out.println("currentDate in ms: " + currentDate.getTime());
    ...
    private static void testDateTimeAPI() {
        ...
        System.out.println("expiryDate: " + expiryDate);
        LocalDate newExpiryDate = expiryDate.plusMonths(8).minusMonths(1);
        System.out.println("newExpiryDate: " + newExpiryDate);

        // Other methods: plus & minus methods, isBefore, isAfter

        LocalDate expiry = LocalDate.of(2023, Month.APRIL , 10);
        System.out.println("expiry "+ expiry);
        LocalDate addSubscription = expiry.plusDays(90);
        System.out.println("Customer extended their subscription , new expiry date is "+ addSubscription);
...
//        // TimeZone ==> ZoneId
        ...
        ZonedDateTime zonedGameStartTime = ZonedDateTime.of(gameStartTime, ZoneId.of("Australia/Sydney"));
        System.out.println("zonedGameStartTime: " + zonedGameStartTime);

        ZonedDateTime zoneDateTimeLondon = zonedGameStartTime.withZoneSameInstant(ZoneId.of("Europe/London"));
        System.out.println("zoneDateTimeLondon : " +zoneDateTimeLondon);
...
//
        ...
        LocalDate dob = LocalDate.of(1997, Month.APRIL, 10);
        Period period1 = dob.until(today);
        System.out.println("\nComplete Age: " + period1);
        System.out.println("\nYears : "+period1.getYears());

        // Use-Case 4: Interval timing (Instant & Duration)

        Instant startTime = Instant.now();
      //  DateTimeDemo.testLegacyDateAPI();
